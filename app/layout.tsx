      ...
      <body id="top">
        <Script id="yandex-metrika" strategy="afterInteractive">
          {`
            ...
            })(window, document, 'script', 'https://mc.yandex.ru/metrika/tag.js?id=112723824', 'ym');

            ym(112723824, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
          `}
        </Script>
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/112723824"
